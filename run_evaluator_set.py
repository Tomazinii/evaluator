...
rag_pipeline = RAGPipelineService(rag_pipeline_url="http://host.docker.internal:8000/rag-fusion")

repository=JsonFileRunEvaluatorSetRepository(dataset_num="dataset3",pattern="rag-fusion")

orchestrator = RunEvaluatorSetUseCase(rag_pipeline=rag_pipeline, repository=repository)
