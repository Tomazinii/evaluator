...
vagas_complex_query =   [0.0, 0.30769, 0.0, 0.0, 0.0]
vagas_comparion_query = [0.75, 0.1666, 0.75, 0.0, 0.75]
vagas_multi_hop =       [1.0, 1.0, 0.8333, 1.0, 1.0]
vagas_open_query =      [0.1764, 0.5294, 0.1764705, 0.47058, 0.17647058]
...
output_path = "./context_recall_decisoes.png"
